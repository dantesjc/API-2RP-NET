...
function Login() {
        return(
            <div className='d-flex flex-row col-12'>
                <div className='d-flex col-6 fundocolor'>
                    <div>
                    <img className='marg' src={require('../../assets/powertech.png')} height='60%' width='80%'/>
                    </div>
                </div>
                <div className='text-light height fundoback d-flex col-6 flex-column justify-content'>
                    <div class='row mt-5'>
                    ...
                    <div class="tpm">
                        <button className='fundo offset-2 mt-5 input'><Link to='/dashboard'> Logar </Link></button>
                    </div>
                </div>    
            </div>
            )
