        ...
        <div className="card-container mb-3">
            ...
            <div>
              <span className="d-flex justify-content-evenly">
                ...
                <div className="d-flex flex-column align-items-center mb-3">Ações <div><button type="button" class="btn btn-success mt-2">Aceitar</button> <button type="button" class="btn btn-danger">Recusar</button></div></div>
              </span>
              </div>            
            </div>
