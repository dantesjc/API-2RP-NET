          ...
          <div className="background d-flex flex-column aling-itens-center">
            ...
            <div className="border">
              ...
              <span className="d-flex justify-content-evenly">
                ...
                <div className="border d-flex flex-column align-items-center">Ações <div><button type="button" class="btn btn-success">Aceitar</button> <button>Recusar</button></div></div>
              </span>
